...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "DemoApp2", Version = "v1" });
...
//Inject context
builder.Services.AddTransient<DemoApp2Context>();
...
if (app.Environment.IsDevelopment() || app.Environment.IsStaging() || app.Environment.IsProduction())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "DemoApp2 API v1");
